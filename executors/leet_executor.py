...
class LeetExecutor(Executor):
    def __init__(self, lang, executor: Executor, formatter):
        from .leetcode_env.utils.formatting import SubmissionFormatter
    ...
    def evaluate(self, name: str, func: str, test: str, timeout: int = 5) -> bool:
        from .leetcode_env.types import LeetCodeSubmission
        from .leetcode_env.utils.leetcode import id_from_slug
